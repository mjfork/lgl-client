# lgl_openapi_3_0_client.AppealsApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_appeals**](AppealsApi.md#v1_appeals) | **GET** /v1/appeals.json | Fetch Appeals


# **v1_appeals**
> AppealsIndex v1_appeals(limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.AppealsApi(api_client)
    ...
    try:
        # Fetch Appeals
        api_response = api_instance.v1_appeals(limit=limit, offset=offset)
        print("The response of AppealsApi->v1_appeals:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AppealsApi->v1_appeals: %s\n" % e)
```
