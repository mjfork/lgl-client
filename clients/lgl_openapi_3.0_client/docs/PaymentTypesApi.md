# lgl_openapi_3_0_client.PaymentTypesApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_payment_types**](PaymentTypesApi.md#v1_payment_types) | **GET** /v1/payment_types.json | Fetch Payment Types


# **v1_payment_types**
> PaymentTypesIndex v1_payment_types(limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.PaymentTypesApi(api_client)
    ...
    try:
        # Fetch Payment Types
        api_response = api_instance.v1_payment_types(limit=limit, offset=offset)
        print("The response of PaymentTypesApi->v1_payment_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentTypesApi->v1_payment_types: %s\n" % e)
```
...
[**PaymentTypesIndex**](PaymentTypesIndex.md)
