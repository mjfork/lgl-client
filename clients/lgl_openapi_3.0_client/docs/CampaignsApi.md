# lgl_openapi_3_0_client.CampaignsApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_campaigns**](CampaignsApi.md#v1_campaigns) | **GET** /v1/campaigns.json | Fetch Campaigns


# **v1_campaigns**
> CampaignsIndex v1_campaigns(limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.CampaignsApi(api_client)
    ...
    try:
        # Fetch Campaigns
        api_response = api_instance.v1_campaigns(limit=limit, offset=offset)
        print("The response of CampaignsApi->v1_campaigns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->v1_campaigns: %s\n" % e)
```
...
[**CampaignsIndex**](CampaignsIndex.md)
