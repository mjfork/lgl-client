# lgl_openapi_3_0_client.FundsApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_funds**](FundsApi.md#v1_funds) | **GET** /v1/funds.json | Fetch Funds


# **v1_funds**
> FundsIndex v1_funds(limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.FundsApi(api_client)
    ...
    try:
        # Fetch Funds
        api_response = api_instance.v1_funds(limit=limit, offset=offset)
        print("The response of FundsApi->v1_funds:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FundsApi->v1_funds: %s\n" % e)
```
