# lgl_openapi_3_0_client.GiftTypesApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_gift_types**](GiftTypesApi.md#v1_gift_types) | **GET** /v1/gift_types.json | Fetch Gift Types


# **v1_gift_types**
> GiftTypesIndex v1_gift_types(limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.GiftTypesApi(api_client)
    ...
    try:
        # Fetch Gift Types
        api_response = api_instance.v1_gift_types(limit=limit, offset=offset)
        print("The response of GiftTypesApi->v1_gift_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GiftTypesApi->v1_gift_types: %s\n" % e)
```
...
[**GiftTypesIndex**](GiftTypesIndex.md)
