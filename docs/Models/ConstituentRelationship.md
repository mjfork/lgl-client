...
|------------ | ------------- | ------------- | -------------|
| **id** | **Integer** | ConstituentRelationship ID | [optional] [default to null] |
...
| **reciprocal\_id** | **Integer** | Reciprocal Relationship Type ID | [optional] [default to null] |
| **rec\_name** | **String** | Reciprocal relationship name | [optional] [default to null] |
| **reciprocal\_description** | **String** | Reciprocal relationship description | [optional] [default to null] |
