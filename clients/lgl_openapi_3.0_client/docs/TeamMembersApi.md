# lgl_openapi_3_0_client.TeamMembersApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_team_members**](TeamMembersApi.md#v1_team_members) | **GET** /v1/team_members.json | Fetch Team Members


# **v1_team_members**
> TeamMembersIndex v1_team_members(limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.TeamMembersApi(api_client)
    ...
    try:
        # Fetch Team Members
        api_response = api_instance.v1_team_members(limit=limit, offset=offset)
        print("The response of TeamMembersApi->v1_team_members:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TeamMembersApi->v1_team_members: %s\n" % e)
```
...
[**TeamMembersIndex**](TeamMembersIndex.md)
