# lgl_openapi_3_0_client.RelationshipTypesApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_relationship_types**](RelationshipTypesApi.md#v1_relationship_types) | **GET** /v1/relationship_types.json | Fetch Relationship Types


# **v1_relationship_types**
> RelationshipTypesIndex v1_relationship_types(limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.RelationshipTypesApi(api_client)
    ...
    try:
        # Fetch Relationship Types
        api_response = api_instance.v1_relationship_types(limit=limit, offset=offset)
        print("The response of RelationshipTypesApi->v1_relationship_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RelationshipTypesApi->v1_relationship_types: %s\n" % e)
```
...
[**RelationshipTypesIndex**](RelationshipTypesIndex.md)
