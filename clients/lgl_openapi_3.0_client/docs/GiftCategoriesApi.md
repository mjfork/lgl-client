# lgl_openapi_3_0_client.GiftCategoriesApi

All URIs are relative to */api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_gift_categories**](GiftCategoriesApi.md#v1_gift_categories) | **GET** /v1/gift_categories.json | Fetch Gift Categories


# **v1_gift_categories**
> GiftCategoriesIndex v1_gift_categories(gift_type_id=gift_type_id, limit=limit, offset=offset)
...
with lgl_openapi_3_0_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lgl_openapi_3_0_client.GiftCategoriesApi(api_client)
    gift_type_id = 'gift_type_id_example' # str | Gift type ID (optional)
    ...
    try:
        # Fetch Gift Categories
        api_response = api_instance.v1_gift_categories(gift_type_id=gift_type_id, limit=limit, offset=offset)
        print("The response of GiftCategoriesApi->v1_gift_categories:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GiftCategoriesApi->v1_gift_categories: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **gift_type_id** | **str**| Gift type ID | [optional] 
...
[**GiftCategoriesIndex**](GiftCategoriesIndex.md)
